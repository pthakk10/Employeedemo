//The Controller we define methods to add Employee record 
//and display employee records as list.

package com.prachitraining.SpringBootRestService.controller;
...
import com.prachitraining.SpringBootRestService.data.EmployeeRepository;
